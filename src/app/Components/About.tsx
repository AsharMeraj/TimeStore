...
const about = () => {
    return (
        <section className='w-full h-fit flex flex-col items-center px-16 max-[500px]:px-12 max-[423px]:px-8 my-[15rem] max-[840px]:my-[5rem] gap-[3.5rem]'>
            <h1 className='min-[1700px]:text-[3.5rem] text-[3rem] font-bold max-[840px]:text-[3rem] max-[602px]:text-[2rem] text-center max-[340px]:text-[1.5rem]'>What Makes Us Unique</h1>
            <main className='flex w-fit gap-24 max-[1155px]:w-full max-[1155px]:gap-0 max-[1155px]:justify-between max-lg:flex-col max-lg:w-fit max-lg:items-center max-lg:gap-10'>
